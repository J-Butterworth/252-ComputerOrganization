public class Sim3_FullAdder {
    ...
    // extras
    private Sim3_HalfAdder halfAdder1;
    private Sim3_HalfAdder halfAdder2;
    private OR or;

    public Sim3_FullAdder()
	{
		a   = new RussWire();
		b   = new RussWire();
        ...
        halfAdder1 = new Sim3_HalfAdder();
        halfAdder2 = new Sim3_HalfAdder();
